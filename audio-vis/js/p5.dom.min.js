...
!function (t, e) {
  ...
  d.prototype.select = function (t, e) {
    ...
    var i,
        n = [],
        r = a(e);
    if (i = "." === t[0] ? (t = t.slice(1), r.getElementsByClassName(t)) : r.getElementsByTagName(t)) for (var o = 0; o < i.length; o++) {
  ...
  function i(t, e, i, n) {
    ...
    if (void 0 !== n) {
      var a = function () {
        n(), r.removeEventListener("canplaythrough", a);
      };
    ...
    return l.loadedmetadata = !1, r.addEventListener("loadedmetadata", function () {
      l.width = r.videoWidth, l.height = r.videoHeight, 0 === l.elt.width && (l.elt.width = r.videoWidth), 0 === l.elt.height && (l.elt.height = r.videoHeight), l.presetPlaybackRate && (l.elt.playbackRate = l.presetPlaybackRate, delete l.presetPlaybackRate), l.loadedmetadata = !0;
    }), l;
  }
  ...
  ["div", "p", "span"].forEach(function (i) {
    ...
    return "object" == typeof e && "SELECT" === e.elt.nodeName ? (t = e, o = this.elt = e.elt) : (o = document.createElement("select"), e && "boolean" == typeof e && o.setAttribute("multiple", "true"), t = c(o, this)), t.option = function (t, e) {
      for (var i, n = 0; n < this.elt.length; n++) if (this.elt[n].innerHTML === t) {
        i = n;
        break;
      }

      if (void 0 !== i) !1 === e ? this.elt.remove(i) : this.elt[i].innerHTML === this.elt[i].value ? this.elt[i].innerHTML = this.elt[i].value = e : this.elt[i].value = e;else {
    ...
    var r,
        ...
        o = 0;
    if (1 < e.length) for (var i = e.length, s = e[0].name, a = e[1].name, l = o = 1; l < i; l++) s !== (a = e[l].name) && o++, s = a;else 1 === e.length && (o = 1);
    ...
    return n.option = function (t, e) {
      ...
      for (e = 0; e < i.length; e++) if (!0 === i[e].checked) return i[e].value;
    }, n.value = function (t) {
      var e,
          i = n._getInputChildrenArray();
    ...
    var o = Math.abs(this.parent().offsetWidth - this.elt.offsetWidth),
        ...
        a = r.y,
        l = r.x;
    return "both" === t || void 0 === t ? this.position(o / 2, s / 2) : "horizontal" === t ? this.position(o / 2, a) : "vertical" === t && this.position(l, s / 2), this.style("display", e), i && this.hide(), n && (this.parent().style.display = "none"), this;
    ...
    } else if ("rotate" === t || "translate" === t || "position" === t) {
    ...
    if (null != this.elt.firstChild && ("checkbox" === this.elt.firstChild.type || "radio" === this.elt.firstChild.type)) for (var e = 0; e < this.elt.childNodes.length; e++) this.elt.childNodes[e].removeAttribute(t);
    ...
    if (this.loadedmetadata) {
      ...
      return this._pixelsTime !== r ? this.loadPixels() : this._ensureCanvas(), d.Renderer2D.prototype.get.call(this, t, e, i, n);
    }
    ...
    var e, i;
    if ("function" == typeof d.prototype.getAudioContext) e = d.prototype.getAudioContext(), i = d.soundOut.input;else try {
...
}), p5.File._createLoader = function (i, n) {
  var t = new FileReader();
  return t.onload = function (t) {
    var e = new p5.File(i);
    e.data = t.target.result, n(e);
  }, t;
}, p5.File._load = function (t, e) {
  if (/^text\//.test(t.type)) p5.File._createLoader(t, e).readAsText(t);else if (/^(video|audio)\//.test(t.type)) {
    var i = new p5.File(t);
    i.data = URL.createObjectURL(t), e(i);
  } else p5.File._createLoader(t, e).readAsDataURL(t);
};