...
!function (t, e) {
  ...
  !function (t, e) {
    ...
    function n(t, e, i) {
      if (Array.isArray(t) || NodeList && t instanceof NodeList) for (var o = 0; o < t.length; o++) n(t[o], e, i);else if ("string" == typeof t) n(document.querySelectorAll(t), e, i);else if (t.jquery && "function" == typeof t.toArray) n(t.toArray(), e, i);else if (Element && t instanceof Element) {
        var s = new r(t, i);
        e.push(s);
      }
    }
    ...
    var r = function (t, e) {
      this._dragged = !1, this._element = t, this._bindedMove = this._moved.bind(this), this._bindedEnd = this._ended.bind(this, e);
    };
  ...
  n = function (e) {
    ...
    return t.prototype.getAudioContext = function () {
      return i;
    }, t.prototype.userStartAudio = function (n, o) {
      var r = n;
      return n instanceof t.Element ? r = n.elt : n instanceof Array && n[0] instanceof t.Element && (r = n.map(function (t) {
        return t.elt;
      })), e(i, r, o);
    }, i;
  }(i);
  ...
  r = function () {
    function e(t) {
      var e, o;
      e = t.getChannelData(0), o = t.numberOfChannels > 1 ? t.getChannelData(1) : e;
      var r = i(e, o),
          s = new window.ArrayBuffer(44 + 2 * r.length),
          a = new window.DataView(s);
      n(a, 0, "RIFF"), a.setUint32(4, 36 + 2 * r.length, !0), n(a, 8, "WAVE"), n(a, 12, "fmt "), a.setUint32(16, 16, !0), a.setUint16(20, 1, !0), a.setUint16(22, 2, !0), a.setUint32(24, 44100, !0), a.setUint32(28, 176400, !0), a.setUint16(32, 4, !0), a.setUint16(34, 16, !0), n(a, 36, "data"), a.setUint32(40, 2 * r.length, !0);

      for (var u = r.length, c = 44, p = 1, h = 0; u > h; h++) a.setInt16(c, r[h] * (32767 * p), !0), c += 2;
    ...
    return t.prototype.soundFormats = function () {
      ...
      if ("string" == typeof e) {
        ...
        if (["mp3", "wav", "ogg", "m4a", "aac"].indexOf(n) > -1) {
          if (t.prototype.isFileSupported(n)) i = i;else for (var o = i.split("."), s = o[o.length - 1], a = 0; a < r.extensions.length; a++) {
        ...
        } else for (var a = 0; a < r.extensions.length; a++) {
          var u = r.extensions[a],
              c = t.prototype.isFileSupported(u);
      ...
      } else if ("object" == typeof e) for (var a = 0; a < e.length; a++) {
        var u = e[a].split(".").pop(),
            c = t.prototype.isFileSupported(u);
  ...
  u = function () {
    ...
    function i(t) {
      for (var e = [], i = Object.keys(t).sort(), n = 0; n < i.length; n++) for (var o = 0; 10 > o; o++) {
        var r = t[i[n]],
            s = t[i[n + o]];
    ...
    function a(t, e, i, n) {
      for (var o = [], r = Object.keys(t).sort(), s = 0; s < r.length; s++) for (var a = r[s], c = t[a], p = 0; p < c.intervals.length; p++) {
    ...
    t.SoundFile = function (e, i, n, o) {
      ...
      if (void 0 !== this.url && "" !== this.url) {
        ...
        o.addEventListener("progress", function (t) {
          ...
          if (200 === o.status) {
            if (!i.panner) return;
            h.decodeAudioData(o.response, function (e) {
        ...
        r.onload = function () {
          i.panner && h.decodeAudioData(r.result, function (e) {
            i.panner && (i.buffer = e, i.panner.inputChannels(e.numberOfChannels), t && t(i));
          });
      ...
      var e = t.toLowerCase();
      if ("restart" === e && this.buffer && this.bufferSourceNode) for (var i = 0; i < this.bufferSourceNodes.length - 1; i++) {
      ...
      var e = t || 0;
      if ("sustain" === this.mode || "untildone" === this.mode) this.stopAll(e), this._playing = !1, this.pauseTime = 0, this._paused = !1;else if (this.buffer && this.bufferSourceNode) {
      ...
      if (this.buffer && this.bufferSourceNode) {
        for (var n = 0; n < this.bufferSourceNodes.length; n++) if (void 0 !== typeof this.bufferSourceNodes[n]) try {
      ...
      if (t || (t = 5 * window.width), this.buffer) {
        for (var e = this.buffer, i = e.length / t, n = ~~(i / 10) || 1, o = e.numberOfChannels, r = new Float32Array(Math.round(t)), s = 0; o > s; s++) for (var a = e.getChannelData(s), u = 0; t > u; u++) {
      ...
      if (p.soundArray.splice(e, 1), this.stop(t), this.buffer && this.bufferSourceNode) {
        for (var i = 0; i < this.bufferSourceNodes.length - 1; i++) if (null !== this.bufferSourceNodes[i]) {
    ...
    t.SoundFile.prototype._initCounterNode = function () {
      ...
      return e._scopeNode && (e._scopeNode.disconnect(), delete e._scopeNode.onaudioprocess, delete e._scopeNode), e._scopeNode = h.createScriptProcessor(256, 1, 1), n.buffer = d(e.buffer), n.playbackRate.setValueAtTime(e.playbackRate, i), n.connect(e._scopeNode), e._scopeNode.connect(t.soundOut._silentNode), e._scopeNode.onaudioprocess = function (t) {
      ...
      g.type = "lowpass", v.connect(g), g.connect(y.destination), v.start(0), y.startRendering(), y.oncomplete = function (o) {
        if (self.panner) {
          var r = o.renderedBuffer,
              s = r.getChannelData(0);

          do h = e(s, f), f -= .005; while (Object.keys(h).length < m && f >= d);
  ...
  h = function () {
    ...
    t.prototype.set = function (e, i, n) {
      if (this.isObject(e)) n = i;else if (this.isString(e)) {
        var o = {};
        o[e] = i, e = o;
      }
      ...
      t: for (var r in e) {
        ...
        if (-1 !== r.indexOf(".")) {
          for (var a = r.split("."), u = 0; u < a.length - 1; u++) if (s = s[a[u]], s instanceof t) {
            a.splice(0, u + 1);
            var c = a.join(".");
            s.set(c, i);
            continue t;
      ...
      if (arguments.length > 1) for (var t = arguments[0], e = 1; e < arguments.length; e++) {
        var i = arguments[e];
        t.connect(i), t = i;
      }
      return this;
    }, t.prototype.chain = function () {
      if (arguments.length > 0) for (var t = this, e = 0; e < arguments.length; e++) {
        var i = arguments[e];
        t.connect(i), t = i;
      }
      return this;
      ...
      var n = {};
      if (1 === t.length && this.isObject(t[0])) n = t[0];else for (var o = 0; o < e.length; o++) n[e[o]] = t[o];
  ...
  d = function (t) {
    return t.TimeBase = function (e, i) {
      ...
      if (this._expr = this._noOp, e instanceof t.TimeBase) this.copy(e);else if (!this.isUndef(i) || this.isNumber(e)) {
      ...
      var n = !1;
      if (!this.isUndef(t)) for (var o in e) {
        var r = e[o];
  ...
  g = function (t) {
    ...
    return t.Emitter = function () {
      ...
      for (var n = e.split(/\W+/), o = 0; o < n.length; o++) if (e = n[o], this._events.hasOwnProperty(e)) if (t.prototype.isUndef(i)) this._events[e] = [];else for (var r = this._events[e], s = 0; s < r.length; s++) r[s] === i && r.splice(s, 1);

      return this;
    }, t.Emitter.prototype.emit = function (t) {
      if (this._events) {
        var e = Array.apply(null, arguments).slice(1);
        if (this._events.hasOwnProperty(t)) for (var i = this._events[t], n = 0, o = i.length; o > n; n++) i[n].apply(this, e);
      }
  ...
  _ = function (t) {
    function e() {
      function e(e, i, o) {
        if (e.input) Array.isArray(e.input) ? (t.prototype.isUndef(o) && (o = 0), this.connect(e.input[o])) : this.connect(e.input, i, o);else try {
      ...
      function i(e, i, n) {
        if (e && e.input && Array.isArray(e.input)) t.prototype.isUndef(n) && (n = 0), this.disconnect(e.input[n], i, n);else if (e && e.input) this.disconnect(e.input, i, n);else try {
  ...
  k = function () {
    ...
    s.setContext(a.audiocontext), t.Signal = function (t) {
      var i = new e(t);
      return i;
    }, e.prototype.fade = e.prototype.linearRampToValueAtTime, n.prototype.fade = e.prototype.fade, i.prototype.fade = e.prototype.fade, r.prototype.fade = e.prototype.fade, e.prototype.setInput = function (t) {
      t.connect(this);
    }, n.prototype.setInput = e.prototype.setInput, i.prototype.setInput = e.prototype.setInput, r.prototype.setInput = e.prototype.setInput, e.prototype.add = function (t) {
      var e = new i(t);
      return this.connect(e), e;
    }, n.prototype.add = e.prototype.add, i.prototype.add = e.prototype.add, r.prototype.add = e.prototype.add, e.prototype.mult = function (t) {
      var e = new n(t);
      return this.connect(e), e;
    }, n.prototype.mult = e.prototype.mult, i.prototype.mult = e.prototype.mult, r.prototype.mult = e.prototype.mult, e.prototype.scale = function (e, i, n, o) {
      var s, a;
    ...
    }, n.prototype.scale = e.prototype.scale, i.prototype.scale = e.prototype.scale, r.prototype.scale = e.prototype.scale;
  }(S, w, A, P, h, o);
  ...
  F = function (t) {
    ...
    return t.Timeline = function () {
      ...
      if (this._iterating) this._toRemove.push(t);else {
  ...
  q = function (t) {
    ...
    return t.TimelineSignal = function () {
      ...
      if (n && n.time === e) this.cancelScheduledValues(e + this.sampleTime);else if (n && n.type === t.TimelineSignal.Type.Curve && n.time + n.duration > e) this.cancelScheduledValues(e), this.linearRampToValueAtTime(i, e);else {
      ...
      if (null === n) o = this._initial;else if (n.type === t.TimelineSignal.Type.Target) {
        var r,
  ...
  E = function () {
    ...
    t.Noise = function (e) {
      var o;
      t.Oscillator.call(this), delete this.f, delete this.freq, delete this.oscillator, o = "brown" === e ? r : "pink" === e ? n : i, this.buffer = o;
  ...
  Q = function () {
    ...
    return t.EQ = function (t) {
      ...
      if (arguments.length === 2 * this.bands.length) for (var t = 0; t < arguments.length; t += 2) this.bands[t / 2].freq(arguments[t]), this.bands[t / 2].gain(arguments[t + 1]);else console.error("Argument mismatch. .set() should be called with " + 2 * this.bands.length + " arguments. (one frequency and gain value pair for each band of the eq)");
  ...
  J = function () {
    ...
    t.Delay = function () {
      ...
      if (t && "number" != typeof t) t.connect(this._leftGain.gain), t.connect(this._rightGain.gain);else {
  ...
  K = function () {
    ...
    t.Reverb = function () {
      ...
      if ("number" == typeof t && t < this.impulses.length && this._setBuffer(this.impulses[t].audioBuffer), "string" == typeof t) for (var e = 0; e < this.impulses.length; e++) if (this.impulses[e].name === t) {
  ...
  nt = function () {
    ...
    t.prototype.setBPM = function (t, e) {
      ...
      this.length = e || 0, this.partStep = 0, this.phrases = [], this.isPlaying = !1, this.noLoop(), this.tatums = o || .0625, this.metro = new t.Metro(), this.metro._init(), this.metro.beatLength(this.tatums), this.metro.setBPM(n), i.parts.push(this), this.callback = function () {};
      ...
      var o;
      if (3 === arguments.length) o = new t.Phrase(e, i, n);else {
  ...
  st = function () {
    ...
    t.SoundRecorder = function () {
      ...
      if (this.recording !== !1 && this.recording === !0) if (this.sampleLimit && this.recordedSamples >= this.sampleLimit) this.stop();else {
  ...
  ht = function () {
    ...
    t.PolySynth = function (n, o) {
      ...
      var a,
          ...
          c = n(o),
          p = r || .1;
      if (this.notes[c] && null !== this.notes[c].getValueAtTime(u) && this.noteRelease(c, 0), this._voicesInUse.getValueAtTime(u) < this.maxVoices) a = Math.max(~~this._voicesInUse.getValueAtTime(u), 0);else {
        a = this._oldest;
  ...
  ft = function () {
    var t = o;
    return t;
  }(e, n, o, r, s, a, u, c, p, k, O, M, V, E, C, z, Q, H, $, J, K, it, nt, ot, rt, st, at, ut, pt, ht, lt, ct, pt, ht);
});